...
def rules(smokingFlag, musicFlag, motionFlag, quietnessFlag):
	df.loc[(df['Smoking'] == smokingFlag) & (df['Music_Lover'] == musicFlag) & (df['Motion_Sickness'] == motionFlag) 
...
uIDList.append(dataListOfSuitableDrivers)
